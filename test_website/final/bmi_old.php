...
<html>
	...
	<div class="bg-text">
        <form>
            ...
            <input id="weight" type="text" placeholder="Your weight in lbs" />
            <br />
            <br />
            <input id="height" type="text" placeholder="Your height in inches" />
            <br />
            <br />
		...
		var result= Math.round(703*weight/(height*height)*100)/100;
